      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 font-sans">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Gestão inteligente de cobranças e inadimplência</p>
          </div>
          
          <button
            onClick={loginWithGoogle}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-slate-300 rounded-xl font-medium text-slate-700 hover:bg-slate-50 transition-all shadow-sm"
          >
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden gap-4">
        ...
        <header className="h-16 glass rounded-2xl flex items-center justify-between px-6 shrink-0">
          ...
          <div className="flex items-center gap-4 shrink-0 relative">
            <button className="p-2 text-slate-500 hover:bg-white/50 rounded-xl relative transition-colors">
              <Bell size={20} />
                ...
                {showCreateDropdown && (
                  <>
                    ...
                    <motion.div
                      ...
                      className="absolute right-0 mt-2 w-48 glass rounded-2xl shadow-xl border border-white/40 p-2 z-50 flex flex-col"
                    >
                      <button 
                        onClick={() => handleCreateAction('client')}
                        className="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-700 hover:bg-white/60 transition-all text-left"
                      >
                        <Users size={16} className="text-blue-500" />
                        NOVO CLIENTE
                      </button>
                      <button 
                        onClick={() => handleCreateAction('debt')}
                        className="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold text-slate-700 hover:bg-white/60 transition-all text-left"
                      >
